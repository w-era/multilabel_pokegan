...
num_gpu = 4
retrain = True
pretrained = './models/dc_rgan_bcel13'
...
if __name__=='__main__':
    ...
    def D_train(batch_size,D,G,D_optimizer,criterion,real_images,real_labels):
        ...
        real_target = torch.cat((torch.ones(batch_size,1).to(device=device),real_labels.to(device=device)),1)[:,:,None,None]
    ...
    ### Log
    log = {'img_list':[],'G_losses':[],'D_losses':[]}
