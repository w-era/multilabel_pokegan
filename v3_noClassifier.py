...
num_gpu = 4
retrain = True
pretrained = './models/dc_rgan_bcel17'
...
class Discriminator(nn.Module):
    def __init__(self,num_gpu):
        ...
        self.convolution = nn.Sequential(
            ...
            nn.Dropout(0.4),
            #4*4
            nn.Conv2d(feature_size*32,label_size,4,1,0,bias=False),
        )
...
if __name__=='__main__':
    ...
    def G_train(batch_size,D,G,G_optimizer,criterion):
        ...
        target = fake_labels[:,:,0][:,:,None,None]
